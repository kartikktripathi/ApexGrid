...
export default function MeetingCard({
  ...
  const isCompleted =
    !isCancelled &&
    raceSession &&
    new Date(raceSession.date_start) < new Date();
    ...
    const fetchPodium = async () => {
      ...
      try {
        ...
        if (p1) {
          ...
          const getDriver = (p) =>
            p ? drivers.find((d) => d.driver_number === p.driver_number) : null;
  ...
  const startDate = new Date(meeting.date_start).toLocaleDateString("en-GB", {
    day: "numeric",
    month: "short",
  });
  const endDate = new Date(meeting.date_end).toLocaleDateString("en-GB", {
    day: "numeric",
    month: "short",
  });
        ...
        >
          {localSessionData && (
            ...
            >
              ...
              >
                {localSessionData.timeString}{" "}
                <span
                  style={{ fontSize: "80%", opacity: 0.5, fontWeight: 500 }}
                >
                  {localSessionData.tzString}
                </span>
              </span>
            </div>
          )}
          ...
          >
            ...
            <span
              style={{ color: isSmall ? "var(--color-text-muted)" : "inherit" }}
            >
                        ...
                        >
                          <span
                            style={{
                              ...
                              height: "5px",
                              borderRadius: "50%",
                              background: `#${driver.team_colour || "ccc"}`,
                            }}
                          />
                          <span
                            style={{
